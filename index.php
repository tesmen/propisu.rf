...
<head>
	...
	<meta name="keywords" itemprop="keywords" content="прописью, калькулятор ндс−онлайн,начислить ндс, ндс калькулятор онлайн, ндс онлайн−калькулятор, ндс от суммы, ндс прописью, онлайн прописью, расчет ндс, сумма прописью, цифры прописью, число прописью" />
...
<div class="wrapper">
	...
	<section class="header">
		...
		<div class="input__container">
			<div id="withNds__popup" class="is__none popup">Значение после второго десятичного знака будет проигнорировано. Округлить?
		...
		<div class="input__container">
			<div id="withOutNds__popup" class="is__none popup">Значение после второго десятичного знака будет проигнорировано. Округлить?
...
function publishExtractNds(number){
	...
	var fixed = trimFrac(summ, 2);
		...
		if (frac.length <= 2) { $( "#withNds__popup" ).addClass("is__none"); $( "#withNds__popup" ).removeClass("is__block") }
